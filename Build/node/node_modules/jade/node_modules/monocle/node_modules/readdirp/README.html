...
warning or errors are emitted</li>
  <li>the stream is <code>paused</code> initially in order to allow <code>pipe</code> and <code>on</code> handlers be connected before data or errors are
emitted</li>
  <li>the stream is <code>resumed</code> automatically during the next event loop </li>
  <li>to learn more about streams, consult the <a href="https://github.com/substack/stream-handbook">stream-handbook</a></li>
</ul>
